    ...
    <div className="demo-workspaces">
        ...
        <div className="demo my_05">
          <div 
            ...
            className={`demo-workplace-buttons boards ${selected === 'boards' ? 'selected' : ''}`}
          >
            <h3>Boards</h3>
          ...
          <div 
            onClick={() => setSelected('lists')} 
            className={`demo-workplace-buttons lists ${selected === 'lists' ? 'selected' : ''}`}
          >
            <h3>Lists</h3>
          ...
          <div 
            ...
            className={`demo-workplace-buttons cards ${selected === 'cards' ? 'selected' : ''}`}
          >
            <h3>Cards</h3>
